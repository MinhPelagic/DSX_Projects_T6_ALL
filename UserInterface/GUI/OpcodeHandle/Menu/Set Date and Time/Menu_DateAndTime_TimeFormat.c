...
void IniOrClrScrFunc_S152_SET_TIME_FORMAT_SET(void)
{
    ...
    DisplayText_Setting_Title(GUI_LANG_GetText(TxtStr_TIME_FORMAT));
    /*Display DATE FORMAT*/
    HandleDisplayTextWithMemdev(IteStat_Select, Set_SetDateTime_TimeFormat_Ctx);
    Display_Icon_Buttons(IconBottDisp_UpBackUpHomeSelect);
}
void UpdOrFlasFunc_S152_SET_TIME_FORMAT_SET(void)
{
    HandleDisplayTextWithMemdev(IteStat_Flashing, Set_SetDateTime_TimeFormat_Ctx);
}
