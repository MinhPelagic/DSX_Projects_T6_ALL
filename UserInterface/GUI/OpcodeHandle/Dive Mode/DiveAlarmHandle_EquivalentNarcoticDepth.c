...
static void ALARM_EquivalentNarcoticDepth_Context(char* pStrRet)
{
    strcpy(pStrRet, GUI_LANG_GetText(TxtStr_EQUI_NAR_DEPTH));
}
const contentDispContext_st ALARM_EquivalentNarcoticDepth =
{
    &ALARM_EquivalentNarcoticDepth_Context,
    &RED_TxtColor,
    GUI_TA_CENTER,
    &FontAaux_3,
...
{
    return (unsigned char)Alarming2.Bit.End;
};
